!function (e) {
    ...
    var l = {TOP_AREA: n(9)},
        c = {
            ...
            increment: function () {
                var e = this.elements;
                o["default"].request({
                    api: "hk.page.increment", v: "1.0", success: function (t) {
            ...
            getSiteView: function () {
                var e = this.elements;
                o["default"].request({
                    api: "hk.site.totalView", v: "1.0", success: function (t) {
            ...
            getTop: function () {
                ...
                o["default"].request({
                    api: "hk.page.getTop", v: "1.0", data: {num: t}, success: function (n) {
    ...
    var a = n(2),
        ...
        i = {
            ...
            request: function () {
                ...
                function t() {
                    u(401, {code: 401, message: "Unsupported API."})
                }
                ...
                }, s = s || {}, n.api || u(400, {code: 400, message: "Please set the api name."});
                ...
                if (p.equalTo("domain", c), n.api.match(/^hk\.page\.get/)) !function () {
                    ...
                    c ? u(c) : p.find().then(function (e) {
                        e = e.map(function (e) {
                            return e.attributes
                        }), o["default"].set("Icarus.pages", e), u(e)
                    }, e)
                }();
                    ...
                    case "hk.page.increment":
                        s.url = s.url || l, s.title = s.title || document.title, p.equalTo("url", s.url), p.find()["try"](function (e) {
                            ...
                            return e.increment("count"), e.save()
                        })["try"](function (e) {
                            e = e.attributes;
            ...
            clearLocalhost: function (e, t) {
                ...
                a.startsWith("domain", "http://localhost"), a.destroyAll().then(function () {
                    console.log("Clear localhost DONE."), e()
                }, t)
            },
            importData: function (e, t) {
                ...
                AV.Promise.when.apply(AV.Promise, o)["try"](function () {
                })["catch"](function (e) {
                    console.log(e)
                })
            }
    ...
    var r = n(3),
        a = {
            EXPIRE_TIME: 300, isSupported: function () {
    ...
    function r(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 3,
            n = e.toString();
        return [].reduce.call(n, function (e, r, a) {
    ...
    function a() {
        document.removeEventListener("DOMContentLoaded", a), window.removeEventListener("load", a), r()
    }
