// pages/presales/presalesOrder.js
...
Page(Object.assign({}, baseHandle, {
  ...
  onSelfAddress: function () {
    ...
    if (that.data.goodsDetailInfo != null) {
      addressUrl += "?goodsId=" + that.data.goodsDetailInfo.id + "&relationId=" + that.data.relationId + "&buyType=" + that.data.buyType + "&type=presale&activityId=" + that.data.orderInfo.activityId + "&totalBuyCount=" + that.data.totalBuyCount;
    }
    wx.redirectTo({
      url: addressUrl,
    })
  ...
  commitOrder: function (e) {
    ...
    isLoading = true;
    let submitUrl = cf.config.pageDomain + '/mobile/base/activity/busi/confirmPreSale';
    that.requestSubMsg(
      that.getMsgConfig(subMsg),
      function (resp) {
        console.log(resp)
        wx.request({
          url: submitUrl,
          ...
          success: function (res) {
            ...
            if (data && 0 == data.ret) {
              ...
              wx.showModal({
                ...
                success: function (res) {
                  wx.redirectTo({
                    url: '/pages/presales/presalesPay?activityId=' + that.data.activityId + "&goodsId=" + that.data.goodsId
                  })
                }
              });
