// pages/time_discount//time_discount_orderpay.js
// order_pay.js
...
Page(Object.assign({}, baseHandle, {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (data && 0 == data.ret) {
          ...
          let members;
          if (ecExtendObj.awardPic && ecExtendObj.awardPic.indexOf('http') !=0){
            ecExtendObj.awardPic = that.data.userImagePath + ecExtendObj.awardPic;
          }
          ...
          that.setData({
            preOrder: preOrder,
            deliveryPrice: data.model.deliveryPrice,
            totalPrice: data.model.totalPrice
          });
          cb && cb();
        }
  ...
  onPayOrder: function () {
    ...
    if (that.data.preOrder.orderAmount <= 0) {
      wx.hideLoading();
      that.setData({
        showModal: true
      })
    ...
    wx.request({
      ...
      data: {
        cusmallToken: cusmallToken,
        goodDescribe: that.data.preOrder.goodsName,
